...
class NovelSource extends AdminBase
{

    public function index()
    {
        return $this->fetch('novel_source/index');
    }
    ...
    public function edit($id=''){
        $vod_class = $this->model('NovelSource');
        ...
        return $this->fetch('novel_source/edit');
    }
